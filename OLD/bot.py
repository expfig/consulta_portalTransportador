        ...
        if len(bot.cte_nums) > 0:
            ...
            for data in bot.data:
                ...
                if data[5] == "Diferença de valor encontrada":
                    ...
                    if is_high_weight:
                        message = f"* Existe uma bobina com 20T ou mais nesse transporte * \n   N conhecimento: {data[1]} - Placa: {data[2]} - Data NFe: {date_nf} - Valor da Usina: {val_usina} - Valor do cte: {val_cte} - Valor divergente: {diff} - Origem: {data[9]} - Destino: {data[10]}"
                    else:

                        message = f"N conhecimento: {data[1]} - Placa: {data[2]} - Data NFe: {date_nf} - Valor da Usina: {val_usina} - Valor do cte: {val_cte} - Valor divergente: {diff} - Origem: {data[9]} - Destino: {data[10]}"
